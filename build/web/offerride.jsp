        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form  id="signup-form" action="offer_serv" class="signup-form"  name="form" method="post">
                        <h2 class="form-title">Offer A Ride</h2>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="other_r" placeholder="Enter Other Route Details..." required/>
                        </div>

                        <div class="form-group">
                            <input type="text" class="form-input" name="v_details" placeholder="Vehicle Details Like, Vehicle  Model Name" required/>
                        </div>
                        <div class="form-group">
                            <input type="number" class="form-input" name="no_seats" placeholder="No. Of Seats Available" required/>
                        </div>

                        <div class="form-group">
                            <input type="text" class="form-input" name="phone" placeholder="Contact No." required/>
                        </div>
                        <div class="form-group">
